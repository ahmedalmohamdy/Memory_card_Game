...
public class gamePane2 extends StackPane {
int btn = 0 ;
int flag = 0 ;
int image1;
int image2;
...
BackgroundImage backgroundImage = new BackgroundImage(new Image("Images2/background.jpg",600,600,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic1 = new BackgroundImage(new Image("Images2/pic1.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic2 = new BackgroundImage(new Image("Images2/pic2.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic3 = new BackgroundImage(new Image("Images2/pic3.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic4 = new BackgroundImage(new Image("Images2/pic4.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic5 = new BackgroundImage(new Image("Images2/pic5.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic6 = new BackgroundImage(new Image("Images2/pic6.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic7 = new BackgroundImage(new Image("Images2/pic7.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage pic8 = new BackgroundImage(new Image("Images2/pic8.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
BackgroundImage fan = new BackgroundImage(new Image("Images2/fan.jpg",100,100,false,true),BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
RotateTransition rotateTransition1 = new RotateTransition();
RotateTransition rotateTransition2 = new RotateTransition();


ImageView table = new ImageView(new Image("Images2/table.png"));
